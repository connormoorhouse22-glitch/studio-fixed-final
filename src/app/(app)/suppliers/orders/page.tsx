...
export default async function SupplierOrdersPage() {
  ...
  const orders: Order[] = (userRole === 'Supplier' || userRole === 'Mobile Service Provider') && userCompany 
    ? await getOrders({ userRole, supplierCompany: userCompany }) 
    : [];

  const pageTitle = "Incoming Orders";
  const pageDescription = "A list of all orders received from producers.";
                ...
                <TableCell>
                   <div className="flex items-center justify-end gap-2">
                    <DropdownMenu>
                        ...
                        <DropdownMenuItem asChild>
                            <a href={`mailto:${order.producerEmail}`}>
                                Contact Producer
                            </a>
                        </DropdownMenuItem>
                        </DropdownMenuContent>
